...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "nl.flores.BlauwtipjeApp.Droid.dll" comes first in this list. */
		"nl.flores.BlauwtipjeApp.Droid.dll",
		"CommonServiceLocator.dll",
		"FormsViewGroup.dll",
		"Microsoft.Azure.Mobile.Client.dll",
		"Microsoft.Azure.Mobile.Client.SQLiteStore.dll",
		"Newtonsoft.Json.dll",
		"nl.flores.BlauwtipjeApp.Core.dll",
		"PCLCrypto.dll",
		"PInvoke.BCrypt.dll",
		...
		"nl.flores.BlauwtipjeApp.Domain.dll",
	};
