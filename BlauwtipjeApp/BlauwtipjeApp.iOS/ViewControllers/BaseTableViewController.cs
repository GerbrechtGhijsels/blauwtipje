...
{
    public abstract class BaseTableActivity<TPresenter> : UITableViewController, IView where TPresenter : IPresenter
    {
        // Base
        ...
        protected internal BaseTableActivity(IntPtr handle) : base(handle)
        {
        }

        protected internal BaseTableActivity() : base()
        {
        }

        public BaseTableActivity(string v, object p)
        {
            this.v = v;
            this.p = p;
        }
