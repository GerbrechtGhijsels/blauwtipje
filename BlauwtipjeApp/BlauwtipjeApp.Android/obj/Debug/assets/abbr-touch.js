...
var abbrTouch = (function () { // eslint-disable-line no-unused-vars
   ...
   * @param {function} target The tap handler to call.
   * @param {function} title The tap handler to call.
   * @param {function} touchX The tap handler to call.
   * @param {function} touchY The tap handler to call.
   */
  function defaultOnTapHandler(target, title, touchX, touchY) { // eslint-disable-line no-unused-vars
      //call function WebAppInterface.androidAltert
      Android.androidAlert(title);
  }
